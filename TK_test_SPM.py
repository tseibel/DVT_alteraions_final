...
#imported 2D arrays
array_1 = sd.resize_array(dp.open(name_1,'')[:,:,:,0])
array_2 = sd.resize_array(dp.open(name_2,'')[:,:,:,0])
...
output_file.write('TOP K FILTERS' + '\n')
for r in res:
    output_file.write(str(r) + ": " + str(final_dict[r]) + '\n')
output_file.close()
